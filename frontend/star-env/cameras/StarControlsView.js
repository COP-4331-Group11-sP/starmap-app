...
const StarControlsView = React.forwardRef(({ camera, starInteraction, ...props }, ref) => {
    var _a;
    ...
    const controls = React.useMemo(() => {
        ...
        if (camera && ((_a = viewRef) === null || _a === void 0 ? void 0 : _a.current)) {
            return new StarControls(camera, starInteraction, viewRef.current);
        }
        return null;
...
export default StarControlsView;
//# sourceMappingURL=StarControlsView.js.map